...
public class HelloController {
    @GetMapping("/hello")
    public String hello(){
        System.out.println("say hello from provider 2 ------");
        return "say hello ------";
    }

    @GetMapping("/hi")
    public String hi(){
        System.out.println("say hi from provider 2 --------");
        return "say hi -------";
    }

    @GetMapping("users/{id}")
    public User findUser(@PathVariable String id){
        System.out.println("findUser invoke from provider 2");
        return new User(id,"张三" + id);
    }

    @GetMapping("users")
    public List<User> findUsers(@RequestParam String ids){
        System.out.println("findUsers invoke from provider 2");
    ...
    public String costWork(){
        System.out.println("provider 2 cost work execute");
        try {
